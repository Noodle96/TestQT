...
void MainWindow::BuildAutomathonToVariables(){
    ...
    afdVariables.fillMatrizAdyacencia("q3","A","q2"); afdVariables.fillMatrizAdyacencia("q3","a","q2");
    afdVariables.fillMatrizAdyacencia("q3","B","q2"); afdVariables.fillMatrizAdyacencia("q3","b","q2");
    afdVariables.fillMatrizAdyacencia("q3","C","q2"); afdVariables.fillMatrizAdyacencia("q3","c","q2");
    afdVariables.fillMatrizAdyacencia("q3","D","q2"); afdVariables.fillMatrizAdyacencia("q3","d","q2");
    afdVariables.fillMatrizAdyacencia("q3","E","q2"); afdVariables.fillMatrizAdyacencia("q3","e","q2");
    afdVariables.fillMatrizAdyacencia("q3","F","q2"); afdVariables.fillMatrizAdyacencia("q3","f","q2");
    afdVariables.fillMatrizAdyacencia("q3","G","q2"); afdVariables.fillMatrizAdyacencia("q3","g","q2");
    afdVariables.fillMatrizAdyacencia("q3","H","q2"); afdVariables.fillMatrizAdyacencia("q3","h","q2");
    afdVariables.fillMatrizAdyacencia("q3","I","q2"); afdVariables.fillMatrizAdyacencia("q3","i","q2");
    afdVariables.fillMatrizAdyacencia("q3","J","q2"); afdVariables.fillMatrizAdyacencia("q3","j","q2");
    afdVariables.fillMatrizAdyacencia("q3","K","q2"); afdVariables.fillMatrizAdyacencia("q3","k","q2");
    afdVariables.fillMatrizAdyacencia("q3","L","q2"); afdVariables.fillMatrizAdyacencia("q3","l","q2");
    afdVariables.fillMatrizAdyacencia("q3","M","q2"); afdVariables.fillMatrizAdyacencia("q3","m","q2");
    afdVariables.fillMatrizAdyacencia("q3","N","q2"); afdVariables.fillMatrizAdyacencia("q3","n","q2");
    afdVariables.fillMatrizAdyacencia("q3","O","q2"); afdVariables.fillMatrizAdyacencia("q3","o","q2");
    afdVariables.fillMatrizAdyacencia("q3","P","q2"); afdVariables.fillMatrizAdyacencia("q3","p","q2");
    afdVariables.fillMatrizAdyacencia("q3","Q","q2"); afdVariables.fillMatrizAdyacencia("q3","q","q2");
    afdVariables.fillMatrizAdyacencia("q3","R","q2"); afdVariables.fillMatrizAdyacencia("q3","r","q2");
    afdVariables.fillMatrizAdyacencia("q3","S","q2"); afdVariables.fillMatrizAdyacencia("q3","s","q2");
    afdVariables.fillMatrizAdyacencia("q3","T","q2"); afdVariables.fillMatrizAdyacencia("q3","t","q2");
    afdVariables.fillMatrizAdyacencia("q3","U","q2"); afdVariables.fillMatrizAdyacencia("q3","u","q2");
    afdVariables.fillMatrizAdyacencia("q3","V","q2"); afdVariables.fillMatrizAdyacencia("q3","v","q2");
    afdVariables.fillMatrizAdyacencia("q3","W","q2"); afdVariables.fillMatrizAdyacencia("q3","w","q2");
    afdVariables.fillMatrizAdyacencia("q3","X","q2"); afdVariables.fillMatrizAdyacencia("q3","x","q2");
    afdVariables.fillMatrizAdyacencia("q3","Y","q2"); afdVariables.fillMatrizAdyacencia("q3","y","q2");
    afdVariables.fillMatrizAdyacencia("q3","Z","q2"); afdVariables.fillMatrizAdyacencia("q3","z","q2");
    afdVariables.fillMatrizAdyacencia("q3","_","q2");
    afdVariables.fillMatrizAdyacencia("q3","0","q2"); afdVariables.fillMatrizAdyacencia("q3","1","q2");
    afdVariables.fillMatrizAdyacencia("q3","2","q2"); afdVariables.fillMatrizAdyacencia("q3","3","q2");
    afdVariables.fillMatrizAdyacencia("q3","4","q2"); afdVariables.fillMatrizAdyacencia("q3","5","q2");
    afdVariables.fillMatrizAdyacencia("q3","6","q2"); afdVariables.fillMatrizAdyacencia("q3","7","q2");
    afdVariables.fillMatrizAdyacencia("q3","8","q2"); afdVariables.fillMatrizAdyacencia("q3","9","q2");
}
